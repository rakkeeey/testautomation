s/* This notice must remain at all times.
...
function pie()
{
 ...
 //this.c_array[0] = new Array(34, 139, 34);
 this.c_array[0] = "#008000";
 this.c_array[1] = "#008000";
 this.c_array[2] = "#FF0000";
// this.c_array[1] = new Array(34, 139, 34);
 //this.c_array[2] = new Array(159, 87, 112);
// this.c_array[2] = new Array(255, 17, 17);
 ...
 this.getColor = function()
  {
   if(this.ct >= (this.c_array.length-1))
      ...
      this.ct++;
     // alert("#" + d2h(this.c_array[this.ct][0]) + d2h(this.c_array[this.ct][1]) + d2h(this.c_array[this.ct][2]));
//alert ("Hello :"+this.ct);
